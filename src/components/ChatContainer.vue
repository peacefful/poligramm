<template>
	<div ref="chatContainer" class="flex flex-col justify-between h-full">
		<div class="bg-blue-900 sticky top-0 p-2">
			<div class="flex items-center justify-between">
				...
				<div v-if="openMenu" class="absolute  top-12 right-2 bg-blue-600 text-white p-2">
					<p @click="openModal" class="cursor-pointer hover:bg-blue-400 p-2 rounded-md">{{ t('addUsers') }}</p>
				</div>
			</div>
		</div>
