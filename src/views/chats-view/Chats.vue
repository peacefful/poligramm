	...
	<div ref="body" class="min-h-screen overflow-x-hidden" v-if="showChats === true">
		...
		<div class="m-2">
			<div class="flex items-center mt-3 justify-between">
				<div class="mr-auto rounded-full p-1 active:bg-[#3090df] ease-in duration-100 block ng:hidden">
					<img src="@/assets/icons/burger-menu.svg">
				</div>
				<Input class="p-3 mr-1" bg="#0054A8" v-model:value="findChat" />
				<Drobdown :is-open-menu="isOpenMenu" @toogle-menu="toogleMenu" :menu="chatListMenu" />
